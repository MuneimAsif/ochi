...
const Footer = () => {
    return (
        <>
            <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5  font-["Neue_Montreal"]'>
                <div className='w-1/2 flex justify-between flex-col h-full'>
                    <div className='heading'>
                        <h1 className='text-[7vw] uppercase leading-none font-extrabold'>Eye</h1>
                        <h1 className='text-[7vw] uppercase leading-none font-extrabold'>Opening</h1>
                    </div>
                ...
                <div className='w-1/2'>
                    <h1 className='text-[6vw] uppercase leading-none font-extrabold'>Presentations</h1>
                    <div className='details mt-10'>
                        <h3 className='mb-5'>S :</h3>
                        {["Facebook", "Instagram", "Twitter", "Linkedin"].map((x, i) => {
                            return <a href='#' className='block text-sm font-light'>{x}</a>
                        })}
                        <h3 className='my-5'>L :</h3>
                        {["2002-1965  W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((x, i) => {
                            return <a href='#' className='block text-sm font-light'>{x}</a>
                        })}
                        <h3 className='mt-3 mb-1'>E :</h3>
                        <a href='#' className='block text-sm font-light'>hello@ochi.design</a>
                    </div>
                </div>
            </div>
        </>
